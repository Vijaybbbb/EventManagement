                                                        ...
                                                        <div className="mobile-ticket__ticket-info">
                                                               ...
                                                               <div className="card__content ticket-info__event">
                                                                      <div className="mobile-ticket__event-info">
                                                                             <span className="event-info__name">Just an Event</span>
                                                                             <span className="event-info__time">Thu. Jul 29, 2021 at 12:00am</span>
                                                                             <span className="event-info__venue"><b>Fake Venue, Pittsburgh, PA</b></span>
                                                                      </div>
                                                               </div>
                                                        </div>
